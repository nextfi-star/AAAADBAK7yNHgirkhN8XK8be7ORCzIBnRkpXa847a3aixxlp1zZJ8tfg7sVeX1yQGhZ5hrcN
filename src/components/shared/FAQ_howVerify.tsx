			...
			<div className='sm:!pt-[40px] sm:!pb-[40px] !pb-[80px] site-holder gap-[15px] flex items-start justify-between'>
				...
				<div className='hidden lg:block sticky top-[50px] rotate-x-[-90deg]'>
					<ScrollArea className='h-[404px] w-[350px] rounded-md border p-4 flex flex-col !gap-[60px]'>
						<a href='#' className='block my-[20px] text-[20px]'>
						...
						<a href='#' className='my-[20px] text-[20px] flex flex-col gap-[15px]'>
						FAQ
						<ul className='flex flex-col gap-[10px] pl-[24px]'>
							<li className='text-[18px] text-[#BDBDBD]'>1. Why do I need to verify again?</li>
							<li className='text-[18px] text-[#BDBDBD]'>2. Why did my identity verification get rejected?</li>
							<li className='text-[18px] text-[#BDBDBD]'>3. Do I need to submit a new form of identification?</li>
						</ul>
						</a>
