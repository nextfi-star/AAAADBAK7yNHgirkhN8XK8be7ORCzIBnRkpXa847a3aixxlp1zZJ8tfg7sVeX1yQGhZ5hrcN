	...
	return (
		<Drawer>
			<DrawerTrigger asChild>
				<Button className={`bg-transparent hover:bg-transparent border border-solid rounded-[50px] text-[#205bc9] dark:text-white border-gray-400`}>{propsItem}</Button>
			</DrawerTrigger>
			...
			<DrawerContent className='z-[9999] px-[30px]'>
				<DrawerHeader>
					...
					<div className=' flex flex-col gap-[38px]'>
						<DrawerDescription className='text-black dark:text-white flex flex-col items-center md:flex gap-[5px] md:items-start bg-[#F5F5F5] dark:bg-[#181818] py-[24px] px-[22px] rounded-[6px]'>
							<Image
						...
						<div className='flex flex-col gap-[10px]'>
							<span className='text-black dark:text-white text-left'>
								Your nickname is used for trading and in-app messages
							</span>
							<input
								type='text'
								className='bg-transparent text-black dark:text-white border border-solid border-[#000] dark:border-white rounded-[4px] px-[20px] py-[10px]'
								onChange={trackSymbols}
								placeholder='zya***@rambler.ru'
							/>
							<span className='w-full flex justify-between text-black dark:text-white text-left'>
				...
				<DrawerFooter className='flex flex-row justify-center gap-[40px]'>
					...
					<DrawerClose asChild>
						<Button className='bg-[#205BC9] text-white rounded-[50px] px-[35px] min-w-[117px] hover:bg-[#205BC9] hover:text-[#fff] '>
							Confirm
						</Button>
					</DrawerClose>
				</DrawerFooter>
