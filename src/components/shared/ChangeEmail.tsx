			...
			<DrawerContent className='z-[9999] px-[30px] min-h-[100dvh] max-h-[70%]'>
				<DrawerHeader>
					<DrawerTitle className='w-full border-transparent border-b-1 border-solid border-b-gray-400 pb-[20px] mb-[20px] text-[14px] md:text-[20px] lg:text-[32px] text-left'>
						<span className='text-[14px] md:text-[20px] lg:text-[32px] text-[#888888]'>
							<DrawerClose asChild>
					...
					<div className='flex justify-center'>
						<div className='flex flex-col items-start gap-[35px] mt-[20px] w-full max-w-[550px]'>
							...
							<div className='flex w-full flex-col items-start gap-[20px] md:gap-[40px]'>
								<label className='text-[#181818] dark:text-white text-[14px] sm:text-[16px] md:text-[17px] lg:text-[20px] flex flex-col items-start gap-[7px] w-full'>
									New email address
									<Input
										type='email'
										placeholder='Enter new email address'
										className='border border-solid border-white text-[14px] md:text-[20px] lg:text-[32px] w-full py-[10px] md:py-[20px] lg:py-[30px] pl-[25px]'
									/>
								</label>
								<label className='text-[#181818] dark:text-white text-[14px] sm:text-[16px] md:text-[17px] lg:text-[20px] flex flex-col items-start gap-[7px] w-full'>
							...
							<DrawerClose asChild>
								<Button className='bg-[#515151] text-white rounded-[50px] px-[35px] min-w-[117px] hover:bg-[#515151] hover:text-[#fff] text-[14px] sm:text-[20px] md:text-[25px] lg:text-[32px] lg:px-[50px] lg:py-[30px]'>
									Confirm
								</Button>
							</DrawerClose>
						</div>
