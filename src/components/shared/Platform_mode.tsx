...
export const Platform_mode = () => {
	return (
		<div className='flex items-center bg-white dark:bg-black border border-solid border-black dark:border-white rounded-[50px] gap-[10px]'>
			<button className='lock-btn flex items-center border-r border-0 border-solid border-r-black dark:border-r-white rounded-[50px] min-h-[30px] max-h-[30px] px-[8px] gap-[3px] text-[14px]'>
				Platform
			...
			<button className='lock-btn flex items-center min-h-[30px] max-h-[30px] px-[8px] gap-[3px] text-[14px]'>
