...
export const Profile_industry: NextPage<Props> = ({ unicClass }) => {
	...
	return (
		<>
			<section
				className={`profile__industy profile_blocks_border md:!bg-[#fff] dark:!bg-transparent md:dark:!bg-[#1e1e1e66] ${unicClass} 2xl:!max-w-[650px] !shadow-none md:!shadow-medium dark:!shadow-none`}
			>
