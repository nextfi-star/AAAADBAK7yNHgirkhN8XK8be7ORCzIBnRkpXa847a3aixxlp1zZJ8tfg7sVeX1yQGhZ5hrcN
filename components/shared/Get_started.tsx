...
export const Get_started = () => {
  ...
  return (
    <section className="main__getstarted" id="main__getstarted">
        ...
        <div className="getstarted__content">
          ...
          >
            ...
            <div className="getstarted__row-item">
              ...
              <p className="getstarted__item-text">{t("tokenDesc")}</p>
          ...
          <div
            ...
            data-aos-once="true"
          >
            <span className="getstarted__item-title">{t("invstBox")}</span>
            <p className="getstarted__item-text">{t("boxDesc")}</p>
