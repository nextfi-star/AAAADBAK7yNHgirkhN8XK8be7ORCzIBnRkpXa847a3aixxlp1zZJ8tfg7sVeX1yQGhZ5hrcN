...
const Allocation = () => {
	...
	return (
		<section
			className='dark:bg-[#3c3c3c66] bg-white shadow-lg rounded-[30px] p-[27px_40px] flex flex-col gap-[20px] mb-[40px]'
		>
			<h3 className='text-[14px] md:text-[20px] 2xl:text-[25px] w-full flex items-center justify-between'>
				Allocation <ArrowBracket width={24} color={theme === 'dark' ? 'white' : 'black'} />{' '}
			</h3>
